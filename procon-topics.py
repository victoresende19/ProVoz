...
with topics:
    with st.form(key='procon'):
        ...
        st.markdown("<span style='text-align: left; font-size:12px'>Obs.: visando encontrar tópicos consistentes, o algoritmo utiliza apenas reclamações com quatro ou mais palavras.<br>", unsafe_allow_html=True)
